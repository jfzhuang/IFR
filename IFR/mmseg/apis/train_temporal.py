...
def train_temporal_segmentor(model,
                             dataset_sup,
                             dataset_unsup,
                             cfg,
                             distributed=False,
    ...
    data_loader_sup = build_dataloader(
        dataset_sup,
        ...
        seed=cfg.seed,
        drop_last=True)
    data_loader_unsup = build_dataloader(
        dataset_unsup,
        cfg.data.samples_per_gpu,
        cfg.data.workers_per_gpu,
        # cfg.gpus will be ignored if distributed
    ...
    if cfg.get('runner') is None:
        ...
        warnings.warn('config is now expected to have a `runner` section, '
    ...
    runner.run([data_loader_sup, data_loader_unsup], cfg.workflow)
