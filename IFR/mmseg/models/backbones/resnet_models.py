    ...
    def __init__(self, block, layers, num_classes=1000, deep_base=False, norm_type=None):
        ...
        if deep_base:
            self.prefix = nn.Sequential(
                OrderedDict([('conv1', nn.Conv2d(3, 64, kernel_size=3, stride=2, padding=1, bias=False)),
            ...
            self.prefix = nn.Sequential(
                OrderedDict([('conv1', nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False)),
