...
sys.path.insert(0, '/ghome/yangli/.local/lib/python3.8/site-packages')
...
class Config:
    ...
    def _substitute_predefined_vars(filename, temp_config_name):
        ...
        support_templates = dict(fileDirname=file_dirname,
        ...
        for k, v in a.items():
            if allow_list_keys and k.isdigit() and isinstance(b, list):
                ...
                if not isinstance(b[k], allowed_types):
                    raise TypeError(f'{k}={v} in child config cannot inherit from base '
