...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM exp/accel18_30_IFR/python/train.py \
        --exp_name accel18_30_IFR \
        --weight_res18 ./pretrained/IFR_30_res18/best_mIoU_iter_39000.pth \
        --weight_res101 ./pretrained/IFR_30_res101/best_mIoU_iter_33000.pth \
